...
var _native=require('../../utils/native');function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}
...
function TransactionHandler(database){_classCallCheck(this,TransactionHandler);
this._transactions={};
this._database=database;

_events.SharedEventEmitter.addListener(
(0,_events.getAppEventName)(this._database,'database_transaction_event'),
this._handleTransactionEvent.bind(this));

}_createClass(TransactionHandler,[{key:'add',value:function add(
...
(0,_native.getNativeModule)(this._database).transactionStart(
reference.path,
id,
applyLocally);
...
default:
(0,_log.getLogger)(this._database).warn('Unknown transaction event type: \''+
event.type+'\'',
event);
