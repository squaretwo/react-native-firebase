...
var _DataSnapshot=require('./DataSnapshot');var _DataSnapshot2=_interopRequireDefault(_DataSnapshot);
var _OnDisconnect=require('./OnDisconnect');var _OnDisconnect2=_interopRequireDefault(_OnDisconnect);
...
Reference=function(_ReferenceBase){_inherits(Reference,_ReferenceBase);
...
path,
existingModifiers)
{_classCallCheck(this,Reference);var _this=_possibleConstructorReturn(this,(Reference.__proto__||Object.getPrototypeOf(Reference)).call(this,
path));
_this._promise=null;
_this._refListeners={};
...
}_createClass(Reference,[{key:'keepSynced',value:function keepSynced(
...
bool){
return(0,_native.getNativeModule)(this._database).keepSynced(
this._getRefKey(),
this.path,
...
value,onComplete){
return(0,_utils.promiseOrCallback)(
(0,_native.getNativeModule)(this._database).set(
this.path,
...
return(0,_utils.promiseOrCallback)(
(0,_native.getNativeModule)(this._database).setPriority(this.path,_priority),
onComplete);
...
return(0,_utils.promiseOrCallback)(
(0,_native.getNativeModule)(this._database).setWithPriority(
this.path,
_value,
_priority),
...
return(0,_utils.promiseOrCallback)(
(0,_native.getNativeModule)(this._database).update(this.path,value),
onComplete);
...
onComplete){
return(0,_utils.promiseOrCallback)(
(0,_native.getNativeModule)(this._database).remove(this.path),
onComplete);
...
{var _this2=this;var applyLocally=arguments.length>2&&arguments[2]!==undefined?arguments[2]:false;
...
_this2._database._transactionHandler.add(
_this2,
transactionUpdate,
onCompleteWrapper,
applyLocally);
...
{var eventName=arguments.length>0&&arguments[0]!==undefined?arguments[0]:'value';var successCallback=arguments[1];var _this3=this;var cancelOrContext=arguments[2];var context=arguments[3];
return(0,_native.getNativeModule)(this._database).
once(this._getRefKey(),this.path,this._query.getModifiers(),eventName).
then(function(_ref){var snapshot=_ref.snapshot;
var _snapshot=new _DataSnapshot2.default(_this3,snapshot);

if((0,_utils.isFunction)(successCallback)){
if((0,_utils.isObject)(cancelOrContext))
successCallback.bind(cancelOrContext)(_snapshot);
if(context&&(0,_utils.isObject)(context))
...
this._database,
this.path+'/'+(0,_utils.generatePushID)(this._database._serverTimeOffset));
...
then(function(){return onComplete(null,newRef);}).

catch(function(error){return onComplete(error,null);}));
...
fnResolve,fnReject){var _this4=this;
...
}},{key:'_setThenable',value:function _setThenable(
...
throw new Error('Query.on failed: First argument must be a valid string event type: "'+
Object.keys(
ReferenceEventTypes).
join(', ')+'"');
...
if(
cancelCallbackOrContext&&
!(0,_utils.isFunction)(cancelCallbackOrContext)&&
!(0,_utils.isObject)(context)&&
!(0,_utils.isObject)(cancelCallbackOrContext))
{
throw new Error(
...
var _context=
cancelCallbackOrContext&&!(0,_utils.isFunction)(cancelCallbackOrContext)?
cancelCallbackOrContext:
context;
var registrationObj={
eventType:eventType,
...
_SyncTree2.default.addRegistration(_extends({},
registrationObj,{
...
{var eventType=arguments.length>0&&arguments[0]!==undefined?arguments[0]:'';var originalCallback=arguments[1];
if(!arguments.length){


return _SyncTree2.default.removeListenersForRegistrations(
_SyncTree2.default.getRegistrationsByPath(this.path));
...
if(
eventType&&(
!(0,_utils.isString)(eventType)||!ReferenceEventTypes[eventType]))
{
throw new Error('Query.off failed: First argument must be a valid string event type: "'+
Object.keys(
ReferenceEventTypes).
join(', ')+'"');
...
var registration=_SyncTree2.default.getOneByPathEventListener(
this.path,
eventType,
originalCallback);
...
return _SyncTree2.default.removeListenerRegistrations(originalCallback,[
registration]);
...
var registrations=_SyncTree2.default.getRegistrationsByPathEvent(
this.path,
eventType);


_SyncTree2.default.removeListenersForRegistrations(
_SyncTree2.default.getRegistrationsByPathEvent(this.path,eventType+'$cancelled'));


return _SyncTree2.default.removeListenersForRegistrations(registrations);
}},{key:'parent',get:function get(){if(this.path==='/')return null;return new Reference(this._database,this.path.substring(0,this.path.lastIndexOf('/')));}},{key:'ref',get:function get(){return this;}},{key:'root',get:function get(){return new Reference(this._database,'/');}}]);return Reference;}(_ReferenceBase3.default);exports.default=Reference;