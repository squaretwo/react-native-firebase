...
var _apps=require('../../utils/apps');var _apps2=_interopRequireDefault(_apps);
var _events=require('../../utils/events');
var _internals=require('../../utils/internals');var _internals2=_interopRequireDefault(_internals);
var _utils=require('../../utils');

var _admob=require('../admob');var _admob2=_interopRequireDefault(_admob);
...
var _crash=require('../crash');var _crash2=_interopRequireDefault(_crash);
var _crashlytics=require('../crashlytics');var _crashlytics2=_interopRequireDefault(_crashlytics);
var _database=require('../database');var _database2=_interopRequireDefault(_database);
var _firestore=require('../firestore');var _firestore2=_interopRequireDefault(_firestore);
var _functions=require('../functions');var _functions2=_interopRequireDefault(_functions);
var _iid=require('../iid');var _iid2=_interopRequireDefault(_iid);
var _invites=require('../invites');var _invites2=_interopRequireDefault(_invites);
var _links=require('../links');var _links2=_interopRequireDefault(_links);
var _messaging=require('../messaging');var _messaging2=_interopRequireDefault(_messaging);
var _notifications=require('../notifications');var _notifications2=_interopRequireDefault(_notifications);


var _perf=require('../perf');var _perf2=_interopRequireDefault(_perf);
var _storage=require('../storage');var _storage2=_interopRequireDefault(_storage);
var _utils2=require('../utils');var _utils3=_interopRequireDefault(_utils2);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}
...
{var _this=this;var fromNative=arguments.length>2&&arguments[2]!==undefined?arguments[2]:false;_classCallCheck(this,App);this._initialized=false;this._nativeInitialized=false;
this._name=name;
...
this.crashlytics=_apps2.default.appModule(this,_crashlytics.NAMESPACE,_crashlytics2.default);
...
this.functions=_apps2.default.appModule(this,_functions.NAMESPACE,_functions2.default);
this.iid=_apps2.default.appModule(this,_iid.NAMESPACE,_iid2.default);
this.invites=_apps2.default.appModule(this,_invites.NAMESPACE,_invites2.default);
...
this.notifications=_apps2.default.appModule(
this,_notifications.NAMESPACE,_notifications2.default);
...
this._extendedProps={};
}_createClass(App,[{key:'extendApp',value:function extendApp(
...
throw new Error(
_internals2.default.STRINGS.ERROR_MISSING_ARG('Object','extendApp'));
...
{
throw new Error(
_internals2.default.STRINGS.ERROR_UNSUPPORTED_CLASS_METHOD('app','delete'));
...
_events.SharedEventEmitter.once('AppReady:'+_this2._name,function(_ref){var error=_ref.error;
...
{
return this._name;
}},{key:'name',get:function get(){return this._name;}},{key:'options',get:function get(){return _extends({},this._options);}}]);return App;}();exports.default=App;