...
var NAMESPACE=exports.NAMESPACE='config';var




RemoteConfig=function(_ModuleBase){_inherits(RemoteConfig,_ModuleBase);


function RemoteConfig(app){_classCallCheck(this,RemoteConfig);var _this=_possibleConstructorReturn(this,(RemoteConfig.__proto__||Object.getPrototypeOf(RemoteConfig)).call(this,
app,{
...
}_createClass(RemoteConfig,[{key:'_nativeValueToJS',value:function _nativeValueToJS(
...
(0,_log.getLogger)(this).debug('Fetching remote config data with expiration '+
expiration.toString());
...
}}]);return RemoteConfig;}(_ModuleBase3.default);exports.default=RemoteConfig;
