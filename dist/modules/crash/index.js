...
var NAMESPACE=exports.NAMESPACE='crash';var

Crash=function(_ModuleBase){_inherits(Crash,_ModuleBase);
function Crash(app){_classCallCheck(this,Crash);var _this=_possibleConstructorReturn(this,(Crash.__proto__||Object.getPrototypeOf(Crash)).call(this,
app,{
...
console.warn(
'Crash Reporting is deprecated, consider switching to Crashlytics which is now the primary crash reporter for Firebase.');return _this;

}_createClass(Crash,[{key:'setCrashCollectionEnabled',value:function setCrashCollectionEnabled(
...
}},{key:'isCrashCollectionEnabled',value:function isCrashCollectionEnabled()
...
}},{key:'logcat',value:function logcat(
...
error){var maxStackSize=arguments.length>1&&arguments[1]!==undefined?arguments[1]:10;
...
}}]);return Crash;}(_ModuleBase3.default);exports.default=Crash;
