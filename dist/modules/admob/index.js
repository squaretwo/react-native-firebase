...
var _Interstitial=require('./Interstitial');var _Interstitial2=_interopRequireDefault(_Interstitial);
var _RewardedVideo=require('./RewardedVideo');var _RewardedVideo2=_interopRequireDefault(_RewardedVideo);
var _AdRequest=require('./AdRequest');var _AdRequest2=_interopRequireDefault(_AdRequest);
var _VideoOptions=require('./VideoOptions');var _VideoOptions2=_interopRequireDefault(_VideoOptions);
var _Banner=require('./Banner');var _Banner2=_interopRequireDefault(_Banner);
var _NativeExpress=require('./NativeExpress');var _NativeExpress2=_interopRequireDefault(_NativeExpress);

var _EventTypes=require('./EventTypes');var _EventTypes2=_interopRequireDefault(_EventTypes);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}
...
var NAMESPACE=exports.NAMESPACE='admob';var

AdMob=function(_ModuleBase){_inherits(AdMob,_ModuleBase);



function AdMob(app){_classCallCheck(this,AdMob);var _this=_possibleConstructorReturn(this,(AdMob.__proto__||Object.getPrototypeOf(AdMob)).call(this,
app,{
...
'interstitial_event',
_this._onInterstitialEvent.bind(_this));

_events.SharedEventEmitter.addListener(
'rewarded_video_event',
_this._onRewardedVideoEvent.bind(_this));return _this;

}_createClass(AdMob,[{key:'_onInterstitialEvent',value:function _onInterstitialEvent(
...
}},{key:'_onRewardedVideoEvent',value:function _onRewardedVideoEvent(
...
}},{key:'openDebugMenu',value:function openDebugMenu()

{
if(!this._initialized){
(0,_log.getLogger)(this).warn(
...
}},{key:'interstitial',value:function interstitial(

adUnit){
return new _Interstitial2.default(this,adUnit);
}},{key:'rewarded',value:function rewarded(

adUnit){
return new _RewardedVideo2.default(this,adUnit);
}}]);return AdMob;}(_ModuleBase3.default);exports.default=AdMob;
