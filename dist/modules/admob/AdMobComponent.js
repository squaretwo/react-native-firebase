...
AdMobComponent=function(_React$Component){_inherits(AdMobComponent,_React$Component);
...
}}]);return AdMobComponent;}(_react2.default.Component);AdMobComponent.propTypes=adMobPropTypes;AdMobComponent.defaultProps={request:new _AdRequest2.default().addTestDevice().build(),video:new _VideoOptions2.default().build()};exports.default=
