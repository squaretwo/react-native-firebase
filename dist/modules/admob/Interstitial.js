...
function Interstitial(admob,adUnit){var _this=this;_classCallCheck(this,Interstitial);this.
...
return(0,_native.getNativeModule)(this._admob).interstitialLoadAd(
this.adUnit,
adRequest);
...
var sub=_events.SharedEventEmitter.addListener('interstitial:'+
