...
function CollectionReference(firestore,collectionPath){_classCallCheck(this,CollectionReference);
this._collectionPath=collectionPath;
this._firestore=firestore;
this._query=new _Query2.default(firestore,collectionPath);
}_createClass(CollectionReference,[{key:'add',value:function add(
...
}},{key:'firestore',get:function get(){return this._firestore;}},{key:'id',get:function get(){return this._collectionPath.id;}},{key:'parent',get:function get(){var parentPath=this._collectionPath.parent();return parentPath?new _DocumentReference2.default(this._firestore,parentPath):null;}}]);return CollectionReference;}();exports.default=CollectionReference;