...
var _FieldValue=require('./FieldValue');var _FieldValue2=_interopRequireDefault(_FieldValue);
...
var _WriteBatch=require('./WriteBatch');var _WriteBatch2=_interopRequireDefault(_WriteBatch);
var _TransactionHandler=require('./TransactionHandler');var _TransactionHandler2=_interopRequireDefault(_TransactionHandler);
...
var NAMESPACE=exports.NAMESPACE='firestore';var




Firestore=function(_ModuleBase){_inherits(Firestore,_ModuleBase);



function Firestore(app){_classCallCheck(this,Firestore);var _this=_possibleConstructorReturn(this,(Firestore.__proto__||Object.getPrototypeOf(Firestore)).call(this,
app,{
...
(0,_events.getAppEventName)(_this,'firestore_collection_sync_event'),
_this._onCollectionSyncEvent.bind(_this));


_events.SharedEventEmitter.addListener(


(0,_events.getAppEventName)(_this,'firestore_document_sync_event'),
_this._onDocumentSyncEvent.bind(_this));return _this;

}_createClass(Firestore,[{key:'batch',value:function batch()
...
}else if((0,_utils.hop)(_settings,'host')&&!(0,_utils.isString)(_settings.host)){
return Promise.reject(
new Error('Firestore.settings failed: settings.host must be a string.'));

}else if(
(0,_utils.hop)(_settings,'persistence')&&
!(0,_utils.isBoolean)(_settings.persistence))
{
return Promise.reject(
new Error(
...
}else if((0,_utils.hop)(_settings,'ssl')&&!(0,_utils.isBoolean)(_settings.ssl)){
return Promise.reject(
new Error('Firestore.settings failed: settings.ssl must be boolean.'));

}else if(
(0,_utils.hop)(_settings,'timestampsInSnapshots')&&
!(0,_utils.isBoolean)(_settings.timestampsInSnapshots))
{
return Promise.reject(
new Error(
...
(0,_events.getAppEventName)(this,'onQuerySnapshotError:'+event.listenerId),
event.error);

}else{
_events.SharedEventEmitter.emit(
(0,_events.getAppEventName)(this,'onQuerySnapshot:'+event.listenerId),
event.querySnapshot);
...
if(event.error){
_events.SharedEventEmitter.emit(
(0,_events.getAppEventName)(this,'onDocumentSnapshotError:'+event.listenerId),
event.error);

}else{
_events.SharedEventEmitter.emit(
(0,_events.getAppEventName)(this,'onDocumentSnapshot:'+event.listenerId),
event.documentSnapshot);

}
}}]);return Firestore;}(_ModuleBase3.default);exports.default=Firestore;
