...
var _DataSnapshot=require('../modules/database/DataSnapshot');var _DataSnapshot2=_interopRequireDefault(_DataSnapshot);
var _Reference=require('../modules/database/Reference');var _Reference2=_interopRequireDefault(_Reference);
...
function SyncTree(){_classCallCheck(this,SyncTree);
this._tree={};
this._reverseLookup={};
if(_reactNative.NativeModules.RNFirebaseDatabase){
this._nativeEmitter=new _reactNative.NativeEventEmitter(
_reactNative.NativeModules.RNFirebaseDatabase);
...
}_createClass(SyncTree,[{key:'_handleSyncEvent',value:function _handleSyncEvent(
...
return _events.SharedEventEmitter.emit(
eventRegistrationKey,
new _DataSnapshot2.default(registration.ref,snapshot),
previousChildName);
...
_extends({},this._reverseLookup[registration]):
null;
...
var subscriptions=_events.SharedEventEmitter._subscriber.getSubscriptionsForType(
registration);
...
var registrationsForPathEvent=Object.entries(
...
registration){
if(!this._reverseLookup[registration])return false;var _reverseLookup$regist=
this._reverseLookup[registration],path=_reverseLookup$regist.path,eventType=_reverseLookup$regist.eventType,once=_reverseLookup$regist.once;
...
}}]);return SyncTree;}();exports.default=
