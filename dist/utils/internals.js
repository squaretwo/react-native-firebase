...
message:
"Google Play service doesn't have one or more required permissions."}};exports.default=
...
ERROR_INIT_SERVICE_URL_UNSUPPORTED:function ERROR_INIT_SERVICE_URL_UNSUPPORTED(namespace){
...
NAMESPACE_PODS[namespace]+'\'" to your Podfile')+

'\r\n\r\nSee http://invertase.link/ios for full setup instructions.');

}

var fbSDKDep='\'com.google.firebase:firebase-'+(GRADLE_DEPS[
namespace]||
namespace)+'\'';
...
fbSDKDep+' in your \'android/app/build.gradle\' ')+('file.\r\n\r\n2) Imported the '+
...
''+(start+'\r\n\r\n-------------------------\r\n')+(
knownError?
knownError.code+': '+knownError.message+' (code '+statusCode+')':'A specific play store availability reason reason was not available (unknown code: '+
